...
# Определяем что в наш ноут лист попадает наша заметка.
# И не попадает в список чужой
...
# Вариант второй:
# (используем параметризацию: объединяем две
# предыдущие функции в одну)
...
# Как и в предыдущем случае — сперва напишем два отдельных теста:
